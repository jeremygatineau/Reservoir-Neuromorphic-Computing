...
void _write_arrays()
{
	...
	outfile__array_defaultclock_dt.open("results\\_array_defaultclock_dt_-5902085376460213261", ios::binary | ios::out);
	...
	outfile__array_defaultclock_t.open("results\\_array_defaultclock_t_3717703264367259510", ios::binary | ios::out);
	...
	outfile__array_defaultclock_timestep.open("results\\_array_defaultclock_timestep_-6566417336013826929", ios::binary | ios::out);
	...
	outfile__array_neurongroup__spikespace.open("results\\_array_neurongroup__spikespace_-523804009278696134", ios::binary | ios::out);
	...
	outfile__array_neurongroup_column.open("results\\_array_neurongroup_column_-4243954821721084756", ios::binary | ios::out);
	...
	outfile__array_neurongroup_i.open("results\\_array_neurongroup_i_-4529531550295660170", ios::binary | ios::out);
	...
	ofstream outfile__array_neurongroup_I;
	outfile__array_neurongroup_I.open("results\\_array_neurongroup_I_141216178056153474", ios::binary | ios::out);
	if(outfile__array_neurongroup_I.is_open())
	{
		outfile__array_neurongroup_I.write(reinterpret_cast<char*>(_array_neurongroup_I), 380160*sizeof(_array_neurongroup_I[0]));
		outfile__array_neurongroup_I.close();
	...
	outfile__array_neurongroup_row.open("results\\_array_neurongroup_row_-8556243612440434018", ios::binary | ios::out);
	...
	outfile__array_neurongroup_run_regularly_clock_dt.open("results\\_array_neurongroup_run_regularly_clock_dt_-8670247919303183418", ios::binary | ios::out);
	...
	outfile__array_neurongroup_run_regularly_clock_t.open("results\\_array_neurongroup_run_regularly_clock_t_-1350468256730449413", ios::binary | ios::out);
	...
	outfile__array_neurongroup_run_regularly_clock_timestep.open("results\\_array_neurongroup_run_regularly_clock_timestep_-7491367983843867964", ios::binary | ios::out);
	...
	outfile__array_neurongroup_v.open("results\\_array_neurongroup_v_-6701920468923057017", ios::binary | ios::out);
	...
	outfile__array_neurongroup_v_th.open("results\\_array_neurongroup_v_th_-8899562637279079807", ios::binary | ios::out);
	...
	outfile__array_spikemonitor__source_idx.open("results\\_array_spikemonitor__source_idx_2570685878728799751", ios::binary | ios::out);
	...
	outfile__array_spikemonitor_count.open("results\\_array_spikemonitor_count_-4538534890625732663", ios::binary | ios::out);
	...
	outfile__array_spikemonitor_N.open("results\\_array_spikemonitor_N_3183941016166556056", ios::binary | ios::out);
	...
	outfile__dynamic_array_spikemonitor_i.open("results\\_dynamic_array_spikemonitor_i_-1761827464682034861", ios::binary | ios::out);
	...
	outfile__dynamic_array_spikemonitor_t.open("results\\_dynamic_array_spikemonitor_t_-759116545328540424", ios::binary | ios::out);
